...
10. Осталось настроить только JMeter. После того как в тест [добавляется Template](#jmeter1) необходимо заполнить только User Defined Variables
