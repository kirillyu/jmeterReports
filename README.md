...
5. Чтобы в Grafana заработали перекрестные ссылки между дашбордами, в случае если она развернута не на localhost, необходимо прописать хост Grafana в переменных двух дашбордов: Test Trends и Test Metrics. 

<img src="https://user-images.githubusercontent.com/9977326/89130169-71462380-d50b-11ea-9563-3d67b745bccf.png" width="100%"></img>

6. Также нам понадобится от Grafana ключ API, который необходимо сгенерировать.
